...
namespace ZarkowTurretDefense.Scripts
{
    ...
    public class ProjectileParticle : MonoBehaviour
    {
        ...
        public TurretBase SourceTurret;
        ...
        private void OnParticleCollision(GameObject other)
        {
            ...
            if (other.TryGetComponent(out Character character) && SourceTurret.IsOwner &&
                character.GetFaction() != Character.Faction.Players && !character.IsTamed() && !character.IsDead())
            {
